...
namespace Corto
{
    public class CortoDecodingObject : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Debug.Log("File to load: " + _crtFileName + ".corto");
            Debug.Log("File Path:" + Application.streamingAssetsPath);

            int numFaces = loader.LoadMeshFromAsset(_crtFileName + ".corto", ref meshes);
